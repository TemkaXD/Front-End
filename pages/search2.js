...
export default function Users() {
    ...
    return (
        <div className="min-h-screen bg-black p-8">
            ...
            <div className={grid ? "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-8" : "space-x-4"}>
            ...
            <button
                className="mt-6 text-black bg-white px-4 py-2 rounded"
                onClick={() => setGrid(!grid)}
            >
                {grid ? "TO LIST" : "TO GRID"}
            </button>
        </div>
    );
}
